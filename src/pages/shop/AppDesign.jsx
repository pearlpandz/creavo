...
import { FaUserAlt, FaAppleAlt, FaBolt, FaCheck  } from "react-icons/fa";
import AppDesignImage from "../../assets/appdesing-image1.png"; // Replace with actual image path
      ...
      <section className="py-5" style={{ backgroundColor: "#fff" }}>
        <div className="container">
          ...
          <p className="lead mb-5 text-center" style={{ color: "#333" }}>
            Intuitive, Engaging, and User-Centric Apps That People Love to Use – We design apps that combine beauty, usability, and functionality.
          </p>
            ...
            {[
              {
                ...
                text: "Every screen is crafted to be intuitive, easy to navigate, and visually appealing, ensuring smooth interactions.",
              },
              {
                icon: <FaAppleAlt  size={30} />,
                title: "Your App - Your Brand in Every Pocket",
                text: "We create mobile app designs that not only look stunning but also deliver seamless user experiences, keeping your audience engaged and coming back.",
              },
              {
                icon: <FaBolt  size={30} />,
                title: "Fast & Responsive Performance",
                text: "Our designs ensure apps work flawlessly with quick loading times and minimal friction, whether on Android or iOS.",
              },
            ].map((card, index) => (
          ...
          <div className="row align-items-center g-5">
            <div className="col-md-6">
              ...
              <p className="lead mb-4" style={{ color: "#333", maxWidth: "400px" }}>
                Your app delivers a flawless, engaging experience on any screen size, from compact smartphones to large tablets.
              </p>
            </div>
            <div className="col-md-6">
              <img
