...
import { FaUserAlt, FaAppleAlt, FaCheck, FaBrain, FaCog , FaClock, FaDollarSign, FaEye, FaClipboardList, FaUsers, FaHandsHelping, FaFileDownload,FaStar    } from "react-icons/fa";
...
const GetDesignersPage = () => {
  ...
  return (
    <>
      ...
      <section className="py-5" style={{ background: "linear-gradient(90deg, rgba(164, 178, 255, 0.6) 0%, rgba(255, 159, 211, 0.6) 100%)" }}>
      ...
      <div className="container">
        <h2 className="display-6 fw-semibold mb-5 text-center" style={{ color: "#000" }}>
...
<section className="py-5" style={{ backgroundColor: "#fff" }}>
  <div className="container">
    ...
    <div className="row g-4 position-relative align-items-stretch">
      {WorksCardData.map((card, index) => (
        <div key={index} className="col-md-3 position-relative d-flex justify-content-center">
          <div
  ...
  margin: "0 auto",
            ...
            <h5 className="fw-semibold mb-2" style={{ color: "#333", fontSize: "1.8rem" }}>
              {card.title}
            </h5>
            <p style={{ color: "#666", fontSize: "1.25rem" }}>{card.text}</p>
            {/* Curved bottom line */}
            <div
              style={{
                position: "absolute",
    ...
    <div className="container">
      <h2 className="fw-semibold text-center mb-4" style={{ fontSize: "2.5rem" }}>
        Our Designers
      </h2>
            ...
            >
              ...
              <div className="d-flex align-items-center mb-3">
                ...
                <div className="ps-3 text-start">
                  <div className="fw-bold" style={{ fontSize: "1.1rem", color: "#111" }}>
                    {designer.name}
                  </div>
                  <div style={{ color: "#444", fontSize: "0.95rem", marginTop: "2px", fontWeight: 500 }}>
                    {designer.profile}
                  </div>
                </div>
              </div>
              {/* Middle: Rating & reviews */}
              <div className="d-flex align-items-center justify-content-between mb-2" style={{ fontSize: "1rem" }}>
                <div className="d-flex align-items-center" style={{ color: "#FBAF04", fontWeight: 600 }}>
                  {[...Array(5)].map((_, i) => (
                    <FaStar key={i} size={14} style={{ marginRight: "3px" }} />
                  ))}
                  <span className="ms-2" style={{ color: "#444", fontSize: "1rem", fontWeight: 500 }}>
                    {designer.rating}
                  </span>
                </div>
